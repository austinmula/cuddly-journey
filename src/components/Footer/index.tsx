...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden bg-[#242424]  text-[white]">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                At Sharpspace, we are passionate about technology and committed
                to providing top-quality computers, accessories, and expert
                laptop repair services. Our goal is to deliver high-performance
                solutions at unbeatable prices. Shop with confidence and let us
          ...
          {/* <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 invisible text-custom-1 font-medium text-[white] lg:text-right">
              Download App
            </h2>
      ...
      {/* <!-- footer bottom start --> */}
      <div className="py-5 xl:py-7.5 bg-[#1d1c1c]">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
