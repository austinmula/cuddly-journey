  ...
  return (
    <div className="group relative flex flex-col bg-[#F8F9FA] rounded-xl overflow-hidden transition-all duration-300 max-w-[300px] w-full mx-auto">
      ...
      <div className="relative bg-[#F6F7FB] overflow-hidden flex-1">
        ...
        {/* Sale badge */}
        <span className="absolute top-3 left-3 z-10 inline-flex items-center text-[11px] font-bold text-white bg-blue rounded-lg px-2 py-[3px] leading-none">
        ...
        <button
          ...
          id="addFavOne"
          className="absolute top-3 right-3 z-10 w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center text-gray-300 hover:text-red-400 hover:shadow-md transition-all duration-200"
        >
        ...
        <Link href={`/product-details/${item.slug.current}`} className="block">
          <div className="flex items-center justify-center h-[260px] p-5">
            <Image
              ...
              width={260}
              height={260}
              className="max-h-full w-auto object-contain transition-transform duration-500 group-hover:scale-105 mix-blend-multiply"
            />
          </div>
        </Link>
