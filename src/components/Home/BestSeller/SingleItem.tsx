    ...
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        ...
        <div className="text-center px-4 py-7.5">
          ...
          <h3 className="font-medium line-clamp text-dark ease-out duration-200 hover:text-blue mb-1.5">
      ...
      <button
        ...
        className="bg-green-light text-white py-2 w-full rounded-md my-4 flex items-center gap-2 justify-center"
      >
