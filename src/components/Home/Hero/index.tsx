    ...
    <section className="overflow-hidden pb-10 lg:pb-12.5 pt-12.5 bg-linear-to-br from-[#E5EAF4] via-[#DDE4F2] to-[#D4DCEE]">
      <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        <div className="grid grid-cols-2 md:grid-cols-7 md:grid-rows-2 gap-2 md:gap-4 max-md:p-4">
          ...
          <div className="col-span-2 md:col-span-3 md:row-span-2 bg-[#467ebd] shadow-3 rounded-lg flex items-center justify-center relative overflow-hidden">
          ...
          <a
            ...
            className="group col-span-1 md:col-start-4 md:col-span-2 shadow-3 relative z-1 overflow-hidden rounded-lg min-h-[140px] md:min-h-[190px]"
          >
            <Image
          ...
          <a
            ...
            className="group col-span-1 md:col-start-4 md:col-span-2 md:row-start-2 shadow-3 relative z-1 overflow-hidden rounded-lg min-h-[140px] md:min-h-[190px]"
          >
            <Image
          ...
          <a
            ...
            className="group col-span-1 md:col-start-6 md:col-span-2 shadow-3 relative z-1 overflow-hidden rounded-lg min-h-[140px] md:min-h-[190px]"
          >
            <Image
          ...
          <a
            ...
            className="group col-span-1 md:col-start-6 md:col-span-2 md:row-start-2 shadow-3 relative z-1 overflow-hidden rounded-lg min-h-[140px] md:min-h-[190px]"
          >
            <Image
