  ...
  return (
    <div className="flex items-center justify-between gap-5">
      <div className="w-full flex items-center gap-4">
        <div className="flex items-center justify-center rounded-[10px] bg-gray-3 max-w-[80px] w-full h-20">
          <Image
            src={
              item.images
        ...
        <div>
          <Link
            href={`/product-details/${item.slug.current}`}
            className="font-medium text-dark text-sm mb-1 ease-out duration-200 hover:text-blue line-clamp-2"
          >
            {item.title}
          </Link>
          <p className="text-custom-sm text-dark/60">
            Kshs.{" "}
      ...
      <button
        ...
        className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-gray-2 border border-gray-3 text-dark ease-out duration-200 hover:bg-red-light-6 hover:border-red-light-4 hover:text-red shrink-0"
      >
        <svg
